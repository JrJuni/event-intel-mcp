...
def test_runtime_paths_module_is_cold(fresh_sys_modules):
    ...
    importlib.import_module("event_intel.storage.artifact_registry")  # Y2.1a (stdlib)
    importlib.import_module("event_intel.runtime.io_contract")  # Y2.1b (stdlib)
    importlib.import_module("event_intel.runtime.job_store")  # Y2.1c (stdlib)
    importlib.import_module("event_intel.tools.get_job")  # Y2.1c tool
    ...
    importlib.import_module("event_intel.runtime.transport")  # Y2.2c (stdlib + mcp lazy)
    importlib.import_module("event_intel.runtime.tool_policy")  # Y2.2d-1 (stdlib)
