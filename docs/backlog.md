...
**ZNC R3 갱신(2026-06-11)**: 운영 전략은 `docs/retry-playbook.md`가 단일 출처 — 검색 lane 스로틀-우선 CONFIRMED(rate-limit 0/900), 본문 lane 패턴별 재시도 코드 반영(4xx 0회/transient 1회). 재시도 상한은 PROVISIONAL(R2 크론은 2026-06-13 취소 — 향후 라이브 런 산출로 수동 재집계).
